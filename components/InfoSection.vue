<template>
  <div class="flex flex-col md:flex-row flex-wrap mt-20 align-middle shadow-md">
    <div class="w-full md:w-1/2 mb-8 md:px-5">
      ...
      <div class="flex h-full flex-col">
        <p class="font-serif text-md line leading-9 mx-4 tracking-wide">
    ...
    <div class="w-full md:w-1/2 md:px-5 flex align-middle">
      <img
